...
class Button(qt.QPushButton):
    ...
    def set_style(
     ...
     # Button Customization
        ...
        """
        if image != '':
            style = no_image + image_style + style 
            
            if name == 'Reload':
               style = no_image + image_style + style + hover_press 
        else: 
            style = no_image + style
        ...
        if image != '':
            style = style_dictionary["base"]+style_dictionary["with_image"]+style_dictionary["style"]
